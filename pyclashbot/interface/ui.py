...
class PyClashBotUI(ttk.Window):
    ...
    def _create_jobs_tab(self) -> None:
        ...
        random_checkbox.grid(row=4, column=0, sticky="w", pady=2)
        ...
        deck_info.grid(row=4, column=2, sticky="e", padx=(0, 2))
        ...
        self.deck_spin.grid(row=4, column=3, sticky="e")
        ...
        cycle_checkbox.grid(row=5, column=0, sticky="w", pady=2)
        ...
        max_deck_info.grid(row=5, column=2, sticky="e", padx=(0, 2))
        ...
        self.max_deck_spin.grid(row=5, column=3, sticky="e")
